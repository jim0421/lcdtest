...
FIQ_Stack_Size  EQU     0x00000c00
IRQ_Stack_Size  EQU     0x00000c00
USR_Stack_Size  EQU     0x00008000
...
;Generial GPIO setting
PINSEL0_Val			EQU 0x00000000
PINSEL1_Val			EQU 0x00000000
PINSEL2_Val			EQU 0x00000000
PINSEL3_Val			EQU 0x00000000
PINSEL4_Val			EQU 0x00000000
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WWEN0_Val   EQU 0x00000004
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WOEN0_Val   EQU 0x00000004
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WRD0_Val    EQU 0x00000009
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WRD1_Val    EQU 0x00000008;0x0000001F
...
;  Setup pin functions for External Bus functionality
				LDR     R4, =PINSEL0_Val
                STR     R4, [R2, #PINSEL0_OFS]
				LDR     R4, =PINSEL1_Val
                STR     R4, [R2, #PINSEL1_OFS]
				LDR     R4, =PINSEL2_Val
                STR     R4, [R2, #PINSEL2_OFS]
				LDR     R4, =PINSEL3_Val
                STR     R4, [R2, #PINSEL3_OFS]
				LDR     R4, =PINSEL4_Val
                STR     R4, [R2, #PINSEL4_OFS]
				...
				LDR     R4, =EMC_PINSEL10_Val
                STR     R4, [R2, #PINSEL10_OFS]
